<x-app-layout>
    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden">
        ...
        <div class="p-8 pb-0 text-center">
            ...
            <h1 class="text-3xl font-extrabold text-on-surface tracking-tight mb-2">Modifier un personnel</h1>
            <p class="text-on-surface-variant body-md max-w-md mx-auto">
                Remplissez les informations pour personnel un personnel de votre entreprise.
            </p>
        </div>
        <!-- Form Start -->
        <form action="{{ route('modifier_personnel',['id_user'=>$user->id]) }}" class="p-8 space-y-8" method="POST" >@csrf @method('PUT')
                ...
                <div class="space-y-4">
                     ...
                     <div class="relative">
                        ...
                        <div class="relative group">
                            ...
                            <input class="sunken-input w-full pl-12 pr-4 py-3.5 rounded-lg text-on-surface font-medium"
                                id="nom" name="nom" placeholder="DUPOND" required type="text" value="{{ $user->nom }}"/>
                        </div>
                    </div>
                     ...
                     <div class="relative">
                        ...
                        <div class="relative group">
                            <span
                                ...
                                data-icon="account">account_circle</span>
                            <input class="sunken-input w-full pl-12 pr-4 py-3.5 rounded-lg text-on-surface font-medium"
                                id="prenom" name="prenom" placeholder="Jean" required type="text" value="{{ $user->prenom }}" />
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative group">
                            ...
                            <input class="sunken-input w-full pl-12 pr-4 py-3.5 rounded-lg text-on-surface font-medium"
                                id="email" name="email" placeholder="admin@queueflow.com" required type="email" value="{{ $user->email }}" />
                        </div>
                    </div>
            ...
            <div class="flex flex-col md:flex-row gap-4 pt-6">
                <button
                    ...
                    type="submit">
                    <span>Modifier le personnel</span>
