<x-app-layout>
    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden">
        ...
        <div class="p-8 pb-0 text-center">
            ...
            <h1 class="text-3xl font-extrabold text-on-surface tracking-tight mb-2">Modifier un service</h1>
            <p class="text-on-surface-variant body-md max-w-md mx-auto">
                Remplissez les informations pour modifier un servive .
            </p>
        </div>
        <!-- Form Start -->
        <form action="{{ route('modifier_service',['id_service'=>$service->id]) }}" class="p-8 space-y-8" method="POST" >@csrf @method('PUT')
            ...
            <section class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative group">
                            ...
                            <input class="sunken-input w-full pl-12 pr-4 py-3.5 rounded-lg text-on-surface font-medium"
                                id="libelle" name="libelle" placeholder="Ex: Retrait"
                                required type="text"  value="{{ $service->libelle }}"/>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative group">
                            <input class="sunken-input w-full pl-12 pr-4 py-3.5 rounded-lg text-on-surface font-medium"
                                id="temps_estime" name="temps_estime" placeholder="10 min"
                                required type="text" value="{{ $service->temps_estime }}" />
                        </div>
                    </div>
                </div>
            </section>
