<x-app-layout>
    ...
    <div class="bg-surface-container-lowest rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden">
        ...
        <div class="p-8 pb-0 text-center">
            ...
            <h1 class="text-3xl font-extrabold text-on-surface tracking-tight mb-2">Ajouter une agence</h1>
            <p class="text-on-surface-variant body-md max-w-md mx-auto">
                Remplissez les informations pour enregistrer une nouvelle agence .
            </p>
        </div>
        <!-- Form Start -->
        <form action="{{ route('enregistrer_agence') }}" class="p-8 space-y-8" method="POST" ">@csrf
